...
class SystemGuideDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final maxWidth = width > 600 ? 560.0 : width - 32;
                    ...
                    child: Stack(
                      ...
                      children: [
                        Center(
                          child: Text(
                            'دليل النظام',
                            style: GoogleFonts.cairo( // تم التغيير من GoogleFonts.cairo
                             // **تم التعديل هنا**
                              color: _darkBlue,
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            // تم إعادة Icon(leadingIcon...) لضمان استخدام الأيقونة الصحيحة التي تم تمريرها
